...
void Mystring::push_bk(char a)
{
	...
	char* buff = new char[length + 2]; // allocate new space to accomodate new char
...
{
	str = new char[strlen(source.str) + 1]; // constructing with an existing copy
	strcpy(str, source.str);
}

// Function to illustrate Move Constructor
Mystring::Mystring(Mystring&& source)// rvalue input
{
	str = source.str;
	source.str = nullptr;
}
