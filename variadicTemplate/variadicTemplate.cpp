...
// Now, the compiler finds a print() function which can take those arguments and in result executes the variadic print() 
// function again in a similar manner: 
// cout<< 2 <<endl ;
...
// cout<< "I will print\n" <<endl ;
// print();
// Now, at this point, the compiler searches for a function overload whose match is the empty function i.e. the function which 
// has no argument. This means that all functions that have 1 or more arguments are matched to the variadic template and all 
// functions that with no argument are matched to the empty function.